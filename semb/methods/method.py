...
class BaseMethod(object):
    ...
    def __init__(self, graph, **kwargs):
        ...
        for key, default_value in self.__PARAMS__.items():
        ...
        for key, value in kwargs.items():
            ...
            if key in self.__CONSTRAINTS__ and not self.__CONSTRAINTS__[key](value):
    ...
    def get_id(self) -> str:
        ...
        """
        raise UnimplementedException("Please implement the get_id() method for indexing your method")
