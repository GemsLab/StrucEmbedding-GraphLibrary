...
SAMPLE_DATA_DIR = os.path.join(os.path.dirname(__file__), "../../../sample-data/ICEWS")
...
class Dataset(BaseDataset):
    ...
    def get_datasets(self) -> List[DatasetInfo]:
        return [
            DatasetInfo(name="ICEWS", description="ICEWS data", \
                    src_url=f'{SAMPLE_DATA_DIR}/ICEWS.edgelist',
                    label_url=f'{SAMPLE_DATA_DIR}/ICEWS_label.txt')]
